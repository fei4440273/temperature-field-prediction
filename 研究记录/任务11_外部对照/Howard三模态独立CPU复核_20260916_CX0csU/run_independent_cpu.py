...
def main():
    assert len(sys.argv) == 2 and sys.argv[1] in {"83", "independent", "independent2"}
    ...
    phase = sys.argv[1]
    prefix = REVIEW / {"83": "独审本人83", "independent": "独立追加IO病例", "independent2": "独立追加IO病例_修对照"}[phase]
    basetemp = REVIEW / {"83": "pytest临时_本人83", "independent": "pytest临时_独立IO", "independent2": "pytest临时_独立IO_修对照"}[phase]
